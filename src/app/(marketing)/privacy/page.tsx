          ...
          <div className="container mx-auto max-w-3xl px-4 space-y-10">
            ...
            <section>
              ...
              <ul className="list-disc space-y-1 pl-6 text-slate-600">
                ...
                <li>Payment status (via Polar - we don&apos;t store card details)</li>
            ...
            <section>
              ...
              <ul className="list-disc space-y-1 pl-6 text-slate-600">
                <li><strong className="font-medium">Contract:</strong> To provide our service to you</li>
                <li><strong className="font-medium">Legitimate interest:</strong> Analytics, security, service improvement</li>
                <li><strong className="font-medium">Legal obligation:</strong> Tax records, fraud prevention</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-600">
                Some services are based outside the UK. We ensure appropriate safeguards
            ...
            <section>
              ...
              <p className="text-slate-600">
                We keep your account data while your account is active and for 2 years after deletion.
                Legal/tax records are kept for 7 years as required by UK law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-3 text-slate-600">Under UK GDPR, you have the right to:</p>
              <ul className="list-disc space-y-1 pl-6 text-slate-600">
