...
export const template: EmailTemplate = {
  ...
  requiredFields: ["planName", "endDate"],
  subject: () => `Your ${appConfig.name} trial ends tomorrow`,
  html: ({ name, planName, endDate }) => `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p style="color: #333; font-size: 16px; line-height: 1.6;">
          To keep using ${appConfig.name} after your trial ends, choose a plan and complete checkout.
        </p>
        <div style="background: #f8f9fa; border-radius: 8px; padding: 16px; margin: 24px 0;">
          <p style="color: #333; font-size: 14px; margin: 0;">
            <strong>Want to continue?</strong> Choose a plan before your trial ends to keep access.
          </p>
        </div>
        <p style="color: #333; font-size: 16px; line-height: 1.6;">
          Ready to continue?
        ...
        <p style="color: #999; font-size: 12px;">
          This is a trial notification. You're receiving it because you have an active trial with ${appConfig.name}.
        </p>
      </div>
    `,
};
